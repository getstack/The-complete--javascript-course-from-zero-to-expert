...
if (dolphinScore > Scorekoalas){

    console.log("Dolphin win the Trophy");

}else if (Scorekoalas > dolphinScore){

    console.logO("koalaso win the Trophy");

} else if (dolphinScore === Scorekoalas){

console.log("Match is draw of both teams ");
